...
sort($temps); echo "Seven lowest temperatures: ".implode(",", array_slice($temps, 0, 7))."<br>";
rsort($temps); echo "Seven highest temperatures: ".implode(",", array_slice($temps, 0, 7))."<br>";
?>
